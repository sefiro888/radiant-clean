...
const corporatePageTranslations = {
  "index.html": [
    ...
    [".sensory-copy > p:nth-of-type(2)", "Los controles Radiant incluyen limpieza visual, presentación, orden y sensación de frescura al entrar en la vivienda.", "Radiant checks include visual cleanliness, presentation, order and a feeling of freshness when entering the property."],
  ...
  "como-trabajo.html": [
    ...
    [".work-perception-copy > p:not(.section-kicker)", "La calidad no se limita a una superficie sin polvo. La presentación, el orden y la sensación de frescura forman parte de la primera impresión y se incorporan al protocolo de revisión.", "Quality is not limited to a dust-free surface. Presentation, order and a sense of freshness shape the first impression and are built into the review protocol."],
