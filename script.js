...
const indexTranslations = [
  ...
  [".testimonials-heading p", "Opiniones reales de propietarios y alojamientos que valoran la tranquilidad, el detalle y una vivienda siempre preparada.", "Real reviews from owners and accommodations who value peace of mind, attention to detail and a property that is always ready."],
  [".testimonial:nth-child(1) .testimonial-badge", "Opinión real", "Real review"],
  [".testimonial:nth-child(1) blockquote", "“Recomiendo ampliamente los servicios de Georgina. Es minuciosa, clara y muy agradable. ¡Totalmente recomendable!”", "“I highly recommend Georgina's services. She is thorough, clear and very pleasant. Absolutely recommended!”"],
  [".testimonial:nth-child(1) figcaption strong", "John Norrby", "John Norrby"],
  [".testimonial:nth-child(1) figcaption span", "Cliente particular", "Private client"],
  [".testimonial:nth-child(2) .testimonial-badge", "Opinión real", "Real review"],
  [".testimonial:nth-child(2) blockquote", "“Georgina y su equipo son una apuesta segura. Servicio de limpieza de calidad, puntualidad y máxima confianza.”", "“Georgina and her team are a safe bet. Quality cleaning service, punctuality and complete trust.”"],
  [".testimonial:nth-child(2) figcaption strong", "Mónica Sánchez García", "Mónica Sánchez García"],
  [".testimonial:nth-child(2) figcaption span", "Propietaria", "Owner"],
  [".testimonial:nth-child(3) .testimonial-badge", "Opinión real", "Real review"],
  [".testimonial:nth-child(3) blockquote", "“Desde el principio recibimos muy buenos comentarios de los huéspedes. Se nota el trabajo profesional en cada detalle.”", "“From the beginning, we received very positive comments from guests. The professional work shows in every detail.”"],
  [".testimonial:nth-child(3) figcaption strong", "Inmaculada", "Inmaculada"],
  [".testimonial:nth-child(3) figcaption span", "Casa Calma", "Casa Calma"],
...
const corporatePageTranslations = {
  ...
  "como-trabajo.html": [
    ...
    [".work-route-heading h2", "Nada se deja a la intuición. Cada área se revisa siguiendo un estándar definido.", "Nothing is left to intuition. Every area is reviewed according to a defined standard."],
